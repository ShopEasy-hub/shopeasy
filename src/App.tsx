        ...
        <SubscriptionPlans
          ...
          onSelectPlan={(planId) => {
            ...
            const planPricing = {
              ...
              'standard': { id: 'standard', name: 'Standard Plan', monthlyPrice: 20000 },
              'growth': { id: 'growth', name: 'Growth / Pro Plan', monthlyPrice: 35000 },
              'enterprise': { id: 'enterprise', name: 'Enterprise Plan', monthlyPrice: 95000 },
            };
