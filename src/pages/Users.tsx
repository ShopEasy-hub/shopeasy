...
import { getUsers, createUser, updateUser, getBranches } from '../lib/api';
...
import { ArrowLeft, Plus, User, Shield, Edit, UserX } from 'lucide-react';
...
export function Users({ appState, onNavigate }: UsersProps) {
  ...
  async function handleAddUser(e: React.FormEvent) {
    ...
    const rolesThatNeedBranch = ['manager', 'cashier'];
    ...
    try {
      await createUser(appState.orgId, newUser);
      ...
      // Show the actual error message, which now includes proper duplicate user detection
