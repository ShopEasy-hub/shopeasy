...
import { Camera, X, Smartphone, Monitor } from 'lucide-react';
...
export function BarcodeScanner({ onScan, isOpen, onClose }: BarcodeScannerProps) {
  ...
  if (scanning) {
    return (
      <div className="scanner-overlay fixed inset-0 z-[9999] bg-black">
        <div className="absolute top-0 left-0 right-0 p-4 bg-gradient-to-b from-black/80 to-transparent">
          <div className="flex flex-col items-center gap-3 text-white">
            <div className="flex items-center gap-2">
              <Camera className="h-6 w-6" />
              <h2 className="text-xl">Scanning Barcode...</h2>
            </div>
